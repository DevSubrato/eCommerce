                ...
                <div class="row">
                    <div class="col-auto align-self-center">
                        <div class="header-logo">
                            <a href="{{route('frontend')}}"><img src="{{asset('frontend')}}/images/logo/logo.png" alt="Site Logo" /></a>
                        </div>
                    </div>
                    ...
                    <div class="col col-lg-auto align-self-center pl-0">
                        <div class="header-actions">
                            ...
                            <a href="#offcanvas-cart"
                                ...
                                <span class="header-action-num">{{cartcheck()->count()}}</span>
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    ...
                    <li>
                        <a href="{{route('productdetails',$wishlist->product->product_slug)}}" class="image"><img src="{{asset('uploads/product_images/'.$wishlist->product->product_image)}}"
                                alt="Cart product Image"></a>
                        <div class="content">
                            <a href="{{route('productdetails',$wishlist->product->product_slug)}}" class="title">{{$wishlist->product->product_name}}</a>
                            <span class="quantity-price"><span class="amount">${{$wishlist->product->product_price}}</span></span>
                            <a href="{{route('product.remove',$wishlist->id)}}" class="remove">×</a>
                        </div>
                    </li>
                    @empty
                        no product to show
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('uploads/product_images/'.$cart->product->product_image)}}"
                                alt="Cart product Image"></a>
                        <div class="content">
                            <a href="single-product.html" class="title">{{$cart->product->product_name}}</a>
                            <span class="quantity-price">{{ $cart->quantity }} x <span class="amount">${{$cart->product->product_price}}</span></span>
                                ...
                                <div class="footer-links">
                                    <div class="footer-row">
                                        <ul class="align-items-center">
                                            ...
                                            <li class="li"><a class="single-link" href="{{route('about.us')}}">About</a></li>
                        ...
                        <div class="col-md-3 col-lg-2 col-sm-6 mb-lm-30px pl-lg-50px">
                            <div class="single-wedge">
                                ...
                                <div class="footer-links">
                                    <div class="footer-row">
                                        <ul class="align-items-center">
                                            <li class="li"><a class="single-link" href="{{route('about.us')}}"> About </a>
                                            </li>
                                            <li class="li"><a class="single-link" href="{{route('all.blogs')}}">Blog</a></li>
                        ...
                        <div class="col-md-3 col-lg-2 col-sm-6 mb-lm-30px pl-lg-50px">
                            <div class="single-wedge">
                                ...
                                <div class="footer-links">
                                    <div class="footer-row">
                                        <ul class="align-items-center">
                                            <li class="li"><a class="single-link" href="{{route('frontend')}}">Jesco</a>
                                            </li>

            ...
            <div class="col-md-4 mb-lm-30px">
                ...
                <div class="team-wrapper">
                    <div class="team-image overflow-hidden">
                        <img src="{{asset('uploads/about_photos/'.$about->image)}}">
                    </div>
                    <div class="team-content">
                        <h6 class="title">{{$about->name}}</h6>
                        <span class="sub-title">{{$about->designation}}</span>
                    </div>
                    <ul class="team-social d-flex">
                        <li><a href="{{$about->facebook}}" target="_blank"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="{{$about->twitter}}"><i class="fa fa-twitter"></i></a></li>
                        <li><a href="{{$about->facebook}}"><i class="fa fa-dribbble"></i></a></li>
